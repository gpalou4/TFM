...
colnames(MOFA.covariates)[8] <- "sample"
...
testFactor <- function(factors, factor, covariable, group, MOFA_samples_metadata) {
  ...
  # Check histogram
  png(paste("MOFA/3.downstream_analysis/regicor/statistical_tests/factors_histograms/factor",factor,"_",covariable,"_",groups,"_groups_hist.png", sep = ""), height=3600, width=6000, res=600, units="px")
  ...
  # Check boxplot
  png(paste("MOFA/3.downstream_analysis/regicor/statistical_tests/factors_boxplots/factor",factor,"_",covariable,"_",groups,"_groups_boxplot.png", sep = ""), height=3600, width=6000, res=600, units="px")
...
write.csv(all.factors.res, file = paste("MOFA/3.downstream_analysis/regicor/statistical_tests/factors_cvd_tests.csv", sep = ""),
          row.names = FALSE)
stop("dew")
...
corrFeatures <- function(matrix, factor, omic) {
  ...
  # With circles
  png(paste("MOFA/3.downstream_analysis/regicor/statistical_tests/",omic,"_correlation_features_1_factor_",factor,".png", sep = ""), height=3600, width=6000, res=600, units="px")
  ...
  png(paste("MOFA/3.downstream_analysis/regicor/statistical_tests/",omic,"_correlation_features_2_factor_",factor,".png", sep = ""), height=3600, width=6000, res=600, units="px")
...
testFeaturesFactor <- function(features.matrix, factor, omic) {
  ...
  for (i in 1:length(colnames(features.matrix))) {
    ...
    # Histogram
    png(paste("MOFA/3.downstream_analysis/regicor/statistical_tests/features_histograms/hist_",colnames(features.matrix)[i],".png", sep = ""), height=3600, width=6000, res=600, units="px")
    ...
    # Boxplot
    png(paste("MOFA/3.downstream_analysis/regicor/statistical_tests/features_boxplots/boxplot_",colnames(features.matrix)[i],".png", sep = ""), height=3600, width=6000, res=600, units="px")
...
factor <- 9
meth.30features.heatmap.name <- load(file = paste("MOFA/3.downstream_analysis/regicor/variance_decomposition/meth_30features_heatmap.RData", sep = ""))
...
meth.heatmap.features.tests.1 <- testFeaturesFactor(features.matrix = M.matrix, factor = 1, omic = "meth")
...
cat("\n\nPerforming histogram, boxplot, t-test and Mann-Whitney-Wilcoxon test for each feature\n\n", file = stdout())
meth.heatmap.features.tests.2 <- testFeaturesFactor(features.matrix = M.matrix, factor = 2, omic = "meth")
...
cat("\n\nPerforming histogram, boxplot, t-test and Mann-Whitney-Wilcoxon test for each feature\n\n", file = stdout())
meth.heatmap.features.tests.3 <- testFeaturesFactor(features.matrix = M.matrix, factor = 3, omic = "meth")
...
cat("\n\nPerforming histogram, boxplot, t-test and Mann-Whitney-Wilcoxon test for each feature\n\n", file = stdout())
meth.heatmap.features.tests.4 <- testFeaturesFactor(features.matrix = M.matrix, factor = 4, omic = "meth")
...
# 
# factor <- 11
# mRNA.20features.heatmap.name <- load(file = paste("MOFA/3.downstream_analysis/regicor/variance_decomposition/mRNA_30features_heatmap.RData", sep = ""))
...
#
#   png(paste("MOFA/3.downstream_analysis/regicor/statistical_tests/features_histograms/hist_",colnames(mRNA.matrix)[i],".png", sep = ""), height=3600, width=6000, res=600, units="px")
...
#   dev.off()
#
#   png(paste("MOFA/3.downstream_analysis/regicor/statistical_tests/features_boxplots/boxplot_",colnames(mRNA.matrix)[i],".png", sep = ""), height=3600, width=6000, res=600, units="px")
...
meth.heatmap.features.tests.3$t_test_adj <- p.adjust(meth.heatmap.features.tests.3$t_test, method = "fdr")
meth.heatmap.features.tests.3$m_whitney_wilcoxon_adj <- p.adjust(meth.heatmap.features.tests.3$m_whitney_wilcoxon, method = "fdr")
meth.heatmap.features.tests.4$t_test_adj <- p.adjust(meth.heatmap.features.tests.4$t_test, method = "fdr")
meth.heatmap.features.tests.4$m_whitney_wilcoxon_adj <- p.adjust(meth.heatmap.features.tests.4$m_whitney_wilcoxon, method = "fdr")
...
write.csv(total.heatmap.features.tests, file = paste("MOFA/3.downstream_analysis/regicor/statistical_tests/heatmap_features_tests.csv", sep = ""),
...
# }
# 
# write.csv(all.factors.res, file = paste("MOFA/3.downstream_analysis/regicor/statistical_tests/factors_chd_cvd_group_tests.csv", sep = ""),
#           row.names = FALSE)
# 
...
#     
#     # Check barplot
#     png(paste("MOFA/3.downstream_analysis/regicor/statistical_tests/cov_plots/",covariable,"_cvd_subgroups_barplot.png", sep = ""), height=3600, width=6000, res=600, units="px")
...
#     
#     # Check histogram
#     png(paste("MOFA/3.downstream_analysis/regicor/statistical_tests/cov_plots/",covariable,"_cvd_subgroups_histogram.png", sep = ""), height=3600, width=6000, res=600, units="px")
...
#     
#     # Check boxplot
#     png(paste("MOFA/3.downstream_analysis/regicor/statistical_tests/cov_plots/",covariable,"_cvd_subgroups_boxplot.png", sep = ""), height=3600, width=6000, res=600, units="px")
...
# cat("\n Tests results\n", file = stdout())
# all.results.df
# write.csv(all.results.df, file = paste("MOFA/3.downstream_analysis/regicor/statistical_tests/cov_within_cvd_subgroups_tests.csv", sep = ""),
#           row.names = FALSE)
